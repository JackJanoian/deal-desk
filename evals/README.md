...
Eval framework for testing DealDesk agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the DealDesk heartbeat skill:
