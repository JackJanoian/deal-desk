...
import * as serverUtils from "@dealdesk/adapter-utils/server-utils";
export type { RunProcessResult } from "@dealdesk/adapter-utils/server-utils";
...
export const buildDealDeskEnv = serverUtils.buildDealDeskEnv;
...
export function buildInvocationEnvForLogs(
  ...
  if (resolvedCommand) {
    merged[options.resolvedCommandEnvKey ?? "DEALDESK_RESOLVED_COMMAND"] =
