...
import type { ToolRunContext } from "@dealdesk/plugin-sdk";
...
type PluginUiSlotDeclaration = NonNullable<NonNullable<DealDeskPluginManifestV1["ui"]>["slots"]>[number];
/** Launcher declaration extracted from plugin manifest */
type PluginLauncherDeclaration = NonNullable<DealDeskPluginManifestV1["launchers"]>[number];
...
interface PluginInstallRequest {
  /** npm package name (e.g., @dealdesk/plugin-linear) or local path */
  packageName: string;
