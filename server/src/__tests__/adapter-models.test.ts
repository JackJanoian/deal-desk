...
import { models as codexFallbackModels } from "@dealdesk/adapter-codex-local";
import { models as cursorFallbackModels } from "@dealdesk/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@dealdesk/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@dealdesk/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.DEALDESK_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.DEALDESK_OPENCODE_COMMAND = "__dealdesk_missing_opencode_command__";
