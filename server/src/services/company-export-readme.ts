 ...
 */
import type { CompanyPortabilityManifest } from "@dealdesk/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [DealDesk](https://dealdesk.ing)");
  lines.push("");
