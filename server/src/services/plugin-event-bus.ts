/**
 * PluginEventBus — typed in-process event bus for the DealDesk plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@dealdesk/shared";
import type { PluginEvent, EventFilter } from "@dealdesk/plugin-sdk";
