...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@dealdesk/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: DealDeskPluginManifestV1, pluginDbId?: string): void;
