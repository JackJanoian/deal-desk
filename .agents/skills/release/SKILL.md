...
name: release
description: >
  Coordinate a full DealDesk release across engineering verification, npm,
...
Run the full DealDesk maintainer release workflow, not just an npm publish.
...
7. If running through DealDesk, you have issue context for status updates and follow-up task creation.
...
DealDesk now uses a commit-driven release model:
...
npm view dealdesk@canary version
```
...
- release summary in DealDesk issue context
