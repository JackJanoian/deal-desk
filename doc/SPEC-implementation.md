...
- `.paperclip.yaml` sidecar for DealDesk-specific fidelity
...
- recurring `TASK.md` entries use `recurring: true` in the base package and DealDesk routine fidelity in `.paperclip.yaml`
