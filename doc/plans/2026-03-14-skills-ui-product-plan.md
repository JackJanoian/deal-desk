...
- `.dealdesk.yaml` may add DealDesk-specific fidelity, but should not replace the base shortname association model
...
- `.dealdesk.yaml` may add DealDesk-specific skill fidelity later if needed, but should not be required for ordinary agent-to-skill association
