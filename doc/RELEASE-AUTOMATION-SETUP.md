...
This document covers the GitHub and npm setup required for the current DealDesk release model:
...
Do this for every public package that DealDesk publishes.
...
2. revoke any personal automation token that used to publish DealDesk
