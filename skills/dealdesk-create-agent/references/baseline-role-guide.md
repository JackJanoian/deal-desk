...
One or two sentences. Name the agent, its role, and its company. State the reporting line. Point at the DealDesk heartbeat skill as the source of truth for the wake procedure.
