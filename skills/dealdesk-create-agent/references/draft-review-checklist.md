...
- [ ] The first paragraph points at the DealDesk skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the DealDesk execution contract verbatim:
...
- [ ] Adapter config matches this DealDesk instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
