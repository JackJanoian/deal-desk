...
- Fire externally: `POST /api/routine-triggers/public/{publicId}/fire`
  ...
  - HMAC: `X-DealDesk-Signature` + `X-DealDesk-Timestamp` headers
...
Use the generic API endpoint tables in `skills/dealdesk/references/api-reference.md` when you need a full cross-domain reference. Use this file when you need routine-specific behaviour, payload shape, or policy details.
