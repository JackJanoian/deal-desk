...
const STORIES = [
  {
    id: "dealdesk-source-issue-recovery--recovery-action-card-states",
    label: "card-states",
  },
  {
    id: "dealdesk-source-issue-recovery--inbox-row-chips",
    label: "inbox-rows",
  },
  {
    id: "dealdesk-source-issue-recovery--blocker-notice-recovery-indicators",
    label: "blocker-notice",
  },
  {
    id: "dealdesk-source-issue-recovery--active-run-panel-recovery-chips",
