...
DealDesk supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying DealDesk?** Use `local_trusted` (the default)
