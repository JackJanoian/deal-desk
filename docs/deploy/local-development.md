...
summary: Set up DealDesk for local development
---

Run DealDesk locally with zero external dependencies.
...
No Docker or external database required. DealDesk uses embedded PostgreSQL automatically.
...
To open DealDesk to a private network with login enabled:
