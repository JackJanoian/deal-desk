...
Manage companies within your DealDesk instance.
...
Company logo uploads use the normal DealDesk attachment size limit.
...
| `logoUrl` | string | Optional DealDesk asset content path for the stored logo image |
