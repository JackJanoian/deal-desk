...
DealDesk organizes autonomous AI work around six key concepts.
...
One DealDesk instance can run multiple companies.
...
Agents don't run continuously. They wake up in **heartbeats** — short execution windows triggered by DealDesk.
