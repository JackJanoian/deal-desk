...
- `DEALDESK_APPROVAL_ID` — the resolved approval
- `DEALDESK_APPROVAL_STATUS` — `approved` or `rejected`
- `DEALDESK_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
