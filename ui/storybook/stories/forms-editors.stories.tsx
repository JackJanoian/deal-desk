...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "@dealdesk/shared";
...
import { createIssue, storybookAgents } from "../fixtures/dealDeskData";
...
const adapterSchema: JsonSchemaNode = {
  ...
  properties: {
    ...
    apiKey: {
      ...
      title: "API key",
      format: "secret-ref",
      description: "Stored with the active DealDesk secret provider.",
    },
    concurrency: {
      type: "integer",
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @dealdesk/ui typecheck", "pnpm build-storybook"],
...
const storybookProject: Project = {
  ...
  goals: [{ id: "goal-company", title: "We're building DealDesk" }],
  name: "Board UI",
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Fixture-backed stories for DealDesk form controls, markdown editors, inline editors, schedule controls, runtime-variable dialogs, and selection pickers.",
      },
    },
  },
} satisfies Meta;
