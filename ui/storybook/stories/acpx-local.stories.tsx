...
import type { AdapterConfigSchema, CreateConfigValues } from "@dealdesk/adapter-utils";
import { parseAcpxStdoutLine } from "@dealdesk/adapter-acpx-local/ui";
import type {
  Agent,
  AgentSkillSnapshot,
...
const acpxLocalConfigSchema: AdapterConfigSchema = {
  fields: [
    ...
    },
    {
      ...
      hint: "Fallback if the ACP agent asks for input outside an interactive session. DealDesk still auto-approves permissions by default.",
    },
    {
      key: "cwd",
      label: "Working directory",
      type: "text",
      hint: "Absolute fallback directory. DealDesk execution workspaces can override this at runtime.",
    },
    {
      key: "stateDir",
      label: "State directory",
      type: "text",
      hint: "Optional ACPX session state directory. Defaults to DealDesk-managed company/agent scoped storage.",
    },
    {
      key: "fastMode",
...
const acpxSkillsCompanyLibrary: CompanySkillListItem[] = [
  {
    ...
    name: "DealDesk",
    description:
      "Coordination skill: heartbeats, checkout, comments, and routine API patterns for DealDesk agents.",
    sourceType: "local_path",
    sourceLocator: "skills/dealdesk",
    sourceRef: null,
    ...
    editable: false,
    editableReason: "Required by DealDesk",
    sourceLabel: "DealDesk",
    sourceBadge: "dealdesk",
    sourcePath: "skills/dealdesk",
  },
  {
    ...
    name: "Design guide",
    description:
      "DealDesk UI design system reference: tokens, typography, status colors, and reusable component patterns.",
    sourceType: "local_path",
...
function buildAcpxClaudeSnapshot(): AgentSkillSnapshot {
  return {
    ...
    supported: true,
    mode: "ephemeral",
    desiredSkills: ["dealdesk", "design-guide"],
    warnings: [],
    entries: [
      {
        key: "dealdesk",
        ...
        managed: true,
        required: true,
        requiredReason: "DealDesk coordination skill is mandatory for control-plane agents.",
        state: "configured",
  ...
  return {
    ...
    entries: [
      ...
      },
      {
        ...
        targetPath: null,
        detail:
          "Desired state is stored in DealDesk only; custom ACP commands need an explicit skill integration contract before runtime sync is available.",
      },
      {
        key: "mobile-app-qa",
        runtimeName: "mobile-app-qa",
...
function AcpxClaudeSkillsStory() {
  ...
  return (
    <StoryFrame
      ...
      subtitle="Runtime-synced state. Selected skills are mounted into the next ACPX Claude session via the DealDesk skills directory."
    >
...
function AcpxCustomSkillsStory() {
  ...
  return (
    <StoryFrame
      ...
      subtitle="Unsupported runtime sync. Desired skills are tracked in DealDesk only until a custom ACP command declares a skill integration contract."
    >
