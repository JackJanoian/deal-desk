...
import type { CompanySecret, EnvBinding } from "@dealdesk/shared";
...
import { storybookCompanies, storybookSecrets } from "../fixtures/dealDeskData";

const COMPANY_ID = "company-storybook";

// Seed localStorage before CompanyContext mounts so its `useState` initializer reads the right id.
if (typeof window !== "undefined") {
  window.localStorage.setItem("dealdesk.selectedCompanyId", COMPANY_ID);
}
