...
import type { Agent, ExecutionWorkspace, Project } from "@dealdesk/shared";
...
function createProject(): Project {
  return {
    ...
    codebase: {
      ...
      repoName: null,
      localFolder: null,
      managedFolder: "/tmp/dealdesk/project-1",
      effectiveLocalFolder: "/tmp/dealdesk/project-1",
