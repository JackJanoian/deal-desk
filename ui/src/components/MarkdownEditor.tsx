...
import { buildAgentMentionHref, buildProjectMentionHref, buildUserMentionHref } from "@dealdesk/shared";
  ...
  if (richEditorError) {
    return (
      <div
        ref={containerRef}
        className={cn(
          "relative dealdesk-mdxeditor-scope",
  ...
  return (
    ...
    >
      <MDXEditor
        ...
        className={cn("dealdesk-mdxeditor", !bordered && "dealdesk-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "dealdesk-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
