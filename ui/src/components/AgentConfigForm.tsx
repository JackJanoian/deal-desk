...
import { AGENT_DEFAULT_MAX_CONCURRENT_RUNS, supportedEnvironmentDriversForAdapter } from "@dealdesk/shared";
...
// Canonical type lives in @dealdesk/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@dealdesk/adapter-utils";
