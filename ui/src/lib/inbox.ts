...
export const DISMISSED_KEY = "dealdesk:inbox:dismissed";
export const READ_ITEMS_KEY = "dealdesk:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "dealdesk:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "dealdesk:inbox:issue-columns";
export const INBOX_NESTING_KEY = "dealdesk:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "dealdesk:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "dealdesk:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "dealdesk:inbox:collapsed-groups";
