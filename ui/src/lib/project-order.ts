...
export const PROJECT_ORDER_UPDATED_EVENT = "dealdesk:project-order-updated";
export const PROJECT_SORT_MODE_UPDATED_EVENT = "dealdesk:project-sort-mode-updated";
const PROJECT_ORDER_STORAGE_PREFIX = "dealdesk.projectOrder";
const PROJECT_SORT_MODE_STORAGE_PREFIX = "dealdesk.projectSortMode";
