 ...
 * `useHostContext` from `@dealdesk/plugin-sdk/ui`.  Those are type-only
 ...
 * registry on `globalThis.__dealDeskPluginBridge__`), context propagation
...
/**
 * Resolve a plugin-provided DealDesk path to the active company scope.
 *
