 ...
 *
 * This is placed on `globalThis.__dealDeskPluginBridge__` and consumed by
...
declare global {
  ...
  var __dealDeskPluginBridge__: PluginBridgeRegistry | undefined;
}
...
function PluginSdkIssuesList({
  ...
  projectId = null,
  filters,
  viewStateKey = "dealdesk:plugin-issues-view",
  initialSearch,
  createIssueLabel,
 ...
 * on `globalThis.__dealDeskPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__dealDeskPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
