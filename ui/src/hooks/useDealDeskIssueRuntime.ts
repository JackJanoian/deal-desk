...
export interface DealDeskIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface DealDeskIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: DealDeskIssueRuntimeReassignment;
}

interface UseDealDeskIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: DealDeskIssueRuntimeSendOptions) => Promise<void>;
...
export function useDealDeskIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseDealDeskIssueRuntimeOptions) {
