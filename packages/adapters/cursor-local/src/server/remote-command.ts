...
import { ensurePathInEnv } from "@dealdesk/adapter-utils/server-utils";
...
async function readSandboxCursorRuntimeInfo(input: {
  ...
  const homeMarker = "__DEALDESK_CURSOR_HOME__:";
  const preferredMarker = "__DEALDESK_CURSOR_AGENT__:";
  try {
