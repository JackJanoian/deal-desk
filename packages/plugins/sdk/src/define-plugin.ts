/**
 * `definePlugin` — the top-level helper for authoring a DealDesk plugin.
 *
...
// ---------------------------------------------------------------------------
// DealDeskPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface DealDeskPlugin {
 ...
 * @returns A sealed `DealDeskPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@dealdesk/plugin-sdk";
