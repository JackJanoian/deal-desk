...
import type { DealDeskPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@dealdesk/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: DealDeskPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@dealdesk/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
