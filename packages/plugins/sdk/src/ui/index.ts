/**
 * `@dealdesk/plugin-sdk/ui` — DealDesk plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@dealdesk/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@dealdesk/plugin-sdk/ui";
 *
 ...
 * - `useHostNavigation()` — navigate DealDesk-internal links through the host router
