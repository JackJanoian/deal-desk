/**
 * DealDesk plugin UI SDK — types for plugin frontend components.
 *
 * Plugin UI bundles import from `@dealdesk/plugin-sdk/ui`.  This subpath
...
/**
 * Options for host-managed DealDesk navigation from plugin UI.
 */
...
export interface HostNavigation {
  /**
   * Resolve a DealDesk-internal path using the active company prefix.
   *
