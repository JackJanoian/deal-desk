/**
 * Bundling presets for DealDesk plugins.
 *
 ...
 * to match the DealDesk plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@dealdesk/plugin-sdk/ui",
    "@dealdesk/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
