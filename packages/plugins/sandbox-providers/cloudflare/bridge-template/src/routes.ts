...
export async function handleBridgeRequest(request: Request, env: BridgeEnv): Promise<Response> {
  ...
  if (request.method === "GET" && pathname === "/api/dealdesk-sandbox/v1/health") {
  ...
  if (request.method === "POST" && pathname === "/api/dealdesk-sandbox/v1/probe") {
  ...
  if (request.method === "POST" && pathname === "/api/dealdesk-sandbox/v1/leases/acquire") {
    ...
    // after creation: DealDesk never sees the lease ID in that case, so it
  ...
  if (request.method === "POST" && pathname === "/api/dealdesk-sandbox/v1/leases/resume") {
  ...
  if (request.method === "POST" && pathname === "/api/dealdesk-sandbox/v1/leases/release") {
  ...
  if (request.method === "DELETE" && pathname.startsWith("/api/dealdesk-sandbox/v1/leases/")) {
  ...
  if (request.method === "POST" && pathname === "/api/dealdesk-sandbox/v1/exec") {
