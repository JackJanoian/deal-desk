...
const manifest: DealDeskPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current DealDesk plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "DealDesk",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the DealDesk domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
