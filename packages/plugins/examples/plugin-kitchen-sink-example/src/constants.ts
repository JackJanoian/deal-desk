import type { PluginLauncherRegistration } from "@dealdesk/plugin-sdk";

export const PLUGIN_ID = "dealdesk-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".dealdesk-kitchen-sink-demo.txt",
} as const;
