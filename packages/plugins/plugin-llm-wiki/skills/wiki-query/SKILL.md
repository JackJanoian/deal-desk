...
6. **When the wiki cannot answer**, say so plainly. Suggest a source the user should ingest, a DealDesk project that would help if distilled, or a web lookup. Never bluff.
