...
WITH wiki_pairs AS (
  ...
  UNION
  SELECT company_id, wiki_id FROM plugin_llm_wiki_8f50da974f.dealdesk_distillation_cursors
  UNION
  SELECT company_id, wiki_id FROM plugin_llm_wiki_8f50da974f.dealdesk_distillation_work_items
  UNION
  SELECT company_id, wiki_id FROM plugin_llm_wiki_8f50da974f.dealdesk_distillation_runs
  UNION
  SELECT company_id, wiki_id FROM plugin_llm_wiki_8f50da974f.dealdesk_source_snapshots
  UNION
  SELECT company_id, wiki_id FROM plugin_llm_wiki_8f50da974f.dealdesk_page_bindings
)
...
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_cursors ADD COLUMN IF NOT EXISTS space_id uuid;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_work_items ADD COLUMN IF NOT EXISTS space_id uuid;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_runs ADD COLUMN IF NOT EXISTS space_id uuid;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_source_snapshots ADD COLUMN IF NOT EXISTS space_id uuid;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_page_bindings ADD COLUMN IF NOT EXISTS space_id uuid;
...
UPDATE plugin_llm_wiki_8f50da974f.dealdesk_distillation_cursors t
SET space_id = s.id
FROM plugin_llm_wiki_8f50da974f.wiki_spaces s
WHERE t.company_id = s.company_id AND t.wiki_id = s.wiki_id AND s.slug = 'default' AND t.space_id IS NULL;

UPDATE plugin_llm_wiki_8f50da974f.dealdesk_distillation_work_items t
SET space_id = s.id
FROM plugin_llm_wiki_8f50da974f.wiki_spaces s
WHERE t.company_id = s.company_id AND t.wiki_id = s.wiki_id AND s.slug = 'default' AND t.space_id IS NULL;

UPDATE plugin_llm_wiki_8f50da974f.dealdesk_distillation_runs t
SET space_id = s.id
FROM plugin_llm_wiki_8f50da974f.wiki_spaces s
WHERE t.company_id = s.company_id AND t.wiki_id = s.wiki_id AND s.slug = 'default' AND t.space_id IS NULL;

UPDATE plugin_llm_wiki_8f50da974f.dealdesk_source_snapshots t
SET space_id = s.id
FROM plugin_llm_wiki_8f50da974f.wiki_spaces s
WHERE t.company_id = s.company_id AND t.wiki_id = s.wiki_id AND s.slug = 'default' AND t.space_id IS NULL;

UPDATE plugin_llm_wiki_8f50da974f.dealdesk_page_bindings t
SET space_id = s.id
FROM plugin_llm_wiki_8f50da974f.wiki_spaces s
WHERE t.company_id = s.company_id AND t.wiki_id = s.wiki_id AND s.slug = 'default' AND t.space_id IS NULL;
...
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_cursors ALTER COLUMN space_id SET NOT NULL;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_work_items ALTER COLUMN space_id SET NOT NULL;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_runs ALTER COLUMN space_id SET NOT NULL;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_source_snapshots ALTER COLUMN space_id SET NOT NULL;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_page_bindings ALTER COLUMN space_id SET NOT NULL;
...
BEGIN
  FOR target IN
    SELECT * FROM (VALUES
      ...
      ('dealdesk_distillation_cursors', ARRAY['company_id', 'wiki_id', 'source_scope', 'scope_key', 'source_kind']::text[]),
      ('dealdesk_distillation_work_items', ARRAY['company_id', 'wiki_id', 'idempotency_key']::text[]),
      ('dealdesk_page_bindings', ARRAY['company_id', 'wiki_id', 'page_path']::text[])
...
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_cursors
...
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_work_items
...
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_page_bindings
...
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_cursors
  DROP CONSTRAINT IF EXISTS dealdesk_distillation_cursors_space_id_fk;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_cursors
  ADD CONSTRAINT dealdesk_distillation_cursors_space_id_fk FOREIGN KEY (space_id) REFERENCES plugin_llm_wiki_8f50da974f.wiki_spaces(id) ON DELETE CASCADE;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_work_items
  DROP CONSTRAINT IF EXISTS dealdesk_distillation_work_items_space_id_fk;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_work_items
  ADD CONSTRAINT dealdesk_distillation_work_items_space_id_fk FOREIGN KEY (space_id) REFERENCES plugin_llm_wiki_8f50da974f.wiki_spaces(id) ON DELETE CASCADE;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_runs
  DROP CONSTRAINT IF EXISTS dealdesk_distillation_runs_space_id_fk;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_distillation_runs
  ADD CONSTRAINT dealdesk_distillation_runs_space_id_fk FOREIGN KEY (space_id) REFERENCES plugin_llm_wiki_8f50da974f.wiki_spaces(id) ON DELETE CASCADE;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_source_snapshots
  DROP CONSTRAINT IF EXISTS dealdesk_source_snapshots_space_id_fk;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_source_snapshots
  ADD CONSTRAINT dealdesk_source_snapshots_space_id_fk FOREIGN KEY (space_id) REFERENCES plugin_llm_wiki_8f50da974f.wiki_spaces(id) ON DELETE CASCADE;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_page_bindings
  DROP CONSTRAINT IF EXISTS dealdesk_page_bindings_space_id_fk;
ALTER TABLE plugin_llm_wiki_8f50da974f.dealdesk_page_bindings
  ADD CONSTRAINT dealdesk_page_bindings_space_id_fk FOREIGN KEY (space_id) REFERENCES plugin_llm_wiki_8f50da974f.wiki_spaces(id) ON DELETE CASCADE;
...
CREATE INDEX IF NOT EXISTS distillation_runs_space_idx ON plugin_llm_wiki_8f50da974f.dealdesk_distillation_runs (company_id, wiki_id, space_id, created_at DESC);
