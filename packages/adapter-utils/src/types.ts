...
export interface AdapterEnvironmentTestContext {
   ...
   *
   * If omitted (or `kind === "local"`), the adapter tests on the DealDesk
...
export interface AdapterRuntimeCommandSpec {
  /**
   * The command DealDesk should execute for this adapter in the current config.
   */
  command: string;
  /**
...
export interface ServerAdapterModule {
   ...
   * rather than reading config.dealDeskRuntimeSkills.
   */
