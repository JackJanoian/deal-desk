...
// @google/gemini-cli. The bootstrap also sets DEALDESK_NPM_BOOTSTRAPPED=1
...
export function buildSandboxNpmInstallCommand(packageName: string): string {
  ...
  return [
    ENSURE_NPM_PREAMBLE,
    'if [ -n "$DEALDESK_NPM_BOOTSTRAPPED" ]; then',
