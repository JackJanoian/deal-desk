...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within DealDeskPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Declares a normal DealDesk agent that a plugin can provision and later
...
export interface PluginManagedAgentDeclaration {
  ...
  /** Suggested DealDesk runtime configuration. */
...
/**
 * Declares a normal DealDesk project that a plugin can provision and later
 * resolve by stable key within each company.
 */
...
/**
 * Lower-bound semver requirement for the DealDesk host.
 *
...
export interface DealDeskPluginManifestV1 {
   ...
   */
  minimumDealDeskVersion?: PluginMinimumHostVersion;
