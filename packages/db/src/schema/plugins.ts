...
import type { PluginCategory, PluginStatus, DealDeskPluginManifestV1 } from "@dealdesk/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<DealDeskPluginManifestV1>().notNull(),
